  ...
  Sync =>
    try
      ...
      if page('.js:contains("Порядок проведения торгов")').length > 0
        action = $('.js:contains("Порядок проведения торгов")').attr('id').replace(':', '%3A')
      ...
      if page('.js:contains("Порядок оформления прав победителя")').length > 0
        action = $('.js:contains("Порядок оформления прав победителя")').attr('id').replace(':', '%3A')
      ...
      if page('.js:contains("Порядок внесения задатка")').length > 0
        action = $('.js:contains("Порядок внесения задатка")').attr('id').replace(':', '%3A')
      ...
      if page('.js:contains("Публикации о торгах")').length > 0
        action = $('.js:contains("Публикации о торгах")').attr('id').replace(':', '%3A')
      ...
      if page('.js:contains("Арбитражный управляющий")').length > 0
        action = $('.js:contains("Арбитражный управляющий")').attr('id').replace(':', '%3A')
      ...
      if page('.js:contains("Порядок ознакомления с имуществом")').length > 0
        action = $('.js:contains("Порядок ознакомления с имуществом")').attr('id').replace(':', '%3A')
