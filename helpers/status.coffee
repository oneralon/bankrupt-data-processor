...
module.exports.statuses = statuses =
  'Извещение опубликовано': [
    ...
    /^Новая$/i
    /^Ожидает начала приема заявок$/i
    /^Опубликован\(\-а\)$/i
    /^Опубликована$/i
    /^Опубликован\(\-а\)$/i
    /^Объявленные торги$/i
  ...
  'Идут торги': [
    ...
    /^подводятся итоги$/i
    /^Подведение итогов Организатором$/i
  ...
  'Торги завершены': [
    ...
    /^Торги завершены$/i
    /^Подписан договор$/i
    /^Торги по лоту проведены$/i
    /^Торги состоялись\, выбран победитель$/i
  ]
  'Торги отменены': [
